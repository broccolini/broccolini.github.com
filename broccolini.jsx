...
<Flex>
  <Container mb={5}>
    ...
    <Box width={[1,1,3/4,2/3]} px={2}>
      <Box width={[1,1/2]} py={4} pr={1} bg='black' height='100%'>
      hi
      </Box>
    </Box>
  </Container>
...
<Flex>
  <Container mb={5}>
    ...
    <Box width={[1,1,3/4,2/3]} px={2}>
      ...
      <Media
      href='http://www.thisismetis.com/blog/design-for-people'
      title='Embracing change in the workplace'
...
<Flex>
  <Container mb={5}>
    ...
    <Media
    href='http://broccolini.net/'
    title='Full Stack Radio interview'
    text='How you develop your design system will influence how you share and encourage adoption of the system.'/>
    <Media
    href='http://broccolini.net/'
