  ...
  return (
    <Box ml={['10%','0']}>
      <Container mt={[5,6,6,'20%']} mb={2}>
        <Box width={[1,1,1,'66.666%']} pl={2} pr={3}>
          <LeadText>
      ...
      <Container mb={[4]}>
        <Box ml={2} bg='black'>
          <Box width={[1,'75%',1,'66.666%']} p={[2,2,2,3]} pr={[2,2,2,2]}>
            <VideoCard
              src='/dsl.png'
      ...
      <Flex>
        <Container mb={4}>
          <Box ml={2}>
            <Box width={[1,1,1,'66.666%','50%']} pr={[2,2,2,3,3]}>
      ...
      <Box mb={4}>
        <Container>
          ...
          <Box ml={2} mb={4} width={[1,1,1,'75%','50%']}>
            <Text fontFamily='mono' fontSize={2} mb={2} pr={[2,2,2,3,3]}>
        ...
        <Flex mb={3} ml={['0','20%','0','0']} style={{ flexWrap: 'wrap' }}>
          <Box width={[1,'75%','33.333%','25%']} px={2} mb={[3,3,4]}>
            <Card
              src='/50-shades.svg'
